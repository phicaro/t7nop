...
<html lang="en">
    ...
    <body ng-app="myApp" ng-controller="myctrl" id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="jumbotron text-center">
            <br>
            <p style="font-size: 50px">Bộ Phận Xét Duyệt</p> 
                    ...
                    <table class="table-hover  table">
                        ...
                        <tbody ng-repeat="t in SP| filter:txtflit">
                            <tr >
                                ...
                                <td>{{t.sodienthoai}}</td>
                                <td>{{t.email}}</td>
                                <td><a href="#"  ng-click="xetduyet(t.id,t.email,'Ban Da Dang Ky Thanh Cong...')" class="btn btn-primary"><span class="glyphicon glyphicon-check"></span>Thanh Cong</a></td>
                                
                                <td><a href="#"  ng-click="xetduyet(t.id,t.email,'Dang Ky Khong Thanh Cong! Ban Vui Long Kiem Tra Lai Thong Tin Cung Cap....')" class="btn btn-primary"><span class="glyphicon glyphicon-check"></span>Khong Thanh Cong</a></td>


                                   <!-- <form method="POST" action="mail_xacnhan/gui_email_smtp.php"> 
                                        <button type="submit" name="message" value="Chuc Mung Ban Da Dang Ky Thanh Cong,Ban Co The Lien He Co quan De Nhan passport" class="btn btn-primary"><span class="glyphicon glyphicon-check"></span>Thành Công</button>
                                    </form>
                                </td> 
                                <td>
                                    <form method="POST" action="mail_xacnhan/gui_email_smtp.php">
                                        <button type="submit"  name="message" value="Ket Qua Dang Ky Ho So Cua Ban Khong Thanh Cong. Vui Long Kiem Tra Lai Thong Tin Cua Ban" class="btn btn-primary"><span class="glyphicon glyphicon-unchecked"></span>Không Thành Công</button>
                                    </form>-->
    ...
    <script>
            ...
            app.controller('myctrl', function ($scope, $http) {
                ...
                $scope.xetduyet = function (idd,emaild,noidungd) {
                    $http.get("mail_xacnhan/gui_email_smtp.php?tenxd=" + idd+"&mailxd="+emaild+"&noidung="+noidungd).then(function (response) {
